...
export const ItemCardContainer = ({contract, callback}: { contract: typeof contractOracleBtc, callback?: any }) => {
...
export default function PairCard({contract, callback, pairInfo, isLoadingPairInfo}: {
