...
const Donate = () => {
    ...
    return (
        <Stack>
                    ...
                    {pairInfo &&
                        ...
                        >
                            <Stat>
                                ...
                                <StatHelpText>{contractBalance * (Number(pairInfo?.value) / 10 ** 5)} $</StatHelpText>
                            </Stat>
                        </Box>
                    }
                </Flex>
            ...
            <>
                <DepositForm myBalance={myBalance} recipient={recipient} pairInfo={pairInfo}
                             submitFormCallback={getData}/>
                <WithdrawForm contractBalance={contractBalance} myBalance={myBalance} recipient={recipient}
                              pairInfo={pairInfo} submitFormCallback={getData}/>
            </>
        </Stack>
    );
};
